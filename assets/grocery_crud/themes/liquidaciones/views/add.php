<?php
	...
	$this->set_js_lib($this->default_theme_path.'/liquidaciones/js/jquery.form.js');
	$this->set_js_config($this->default_theme_path.'/liquidaciones/js/flexigrid-add.js');
	...
	<?php echo form_open( $insert_url, 'method="post" id="crudForm" autocomplete="off" enctype="multipart/form-data"'); ?>
		<div class='form-div'>
			...
			<div class='form-field-box <?php echo $even_odd?>' id="<?php echo $field->field_name; ?>_field_box">
				<div align="left" class='form-display-as-box' id="<?php echo $field->field_name; ?>_display_as_box">

<?php
class User_privilege2  extends grocery_crud_model_Postgre  {
	...
	function get_list()
        ...
        {
            //$this->querys->set_where_propietarios($this->table_name); Se quito esto porque no permitia modificar registros desde un usuario con empresas asignadas
            $primary_key_field = $this->get_primary_key();

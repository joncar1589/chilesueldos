...
'certificado_electronico','tipo_contribuyente','total_acciones',
        ...
        public function liquidaciones($x = '',$y = '')
	{
            ...
            $crud->fields(
					'empresa','empleado','fecha','dias_mes','dias_trabajados','sueldo_base','sueldo_base_proporcional','cantidad_horas','factor_hora_extra','hrs_extras','bonos_ficha','comisiones','bonos','aguinaldos','preimponible','sub_totales_haberes','tope_imponible','total_imponible',
                    ...
                    'cotizacion_obligatoria_salud','cotizacion_adicional','total_fonasa','caja_comp','impuesto_trabajador','costo_total_empleador');
            //Fields                       
            //unsets            
            //Displays
            $crud->display_as('fecha','Fecha de emision')
				 ...
				 ->display_as('caja_comp','Caja de Compensacion');
			...
			$crud->field_type('inp_mutual','hidden');

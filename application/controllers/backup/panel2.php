...
class Panel extends Main {
	...
	public function __construct()
	{
		parent::__construct();
                ...
                $this->db->dbnotprefix = array('dbclientes112010');    
...
'certificado_electronico','tipo_contribuyente','total_acciones',
        ...
        public function banner($x = '',$y = '')
	{
        ...
        function notificaciones($x='',$y='')
        {
            ...
            $crud->field_type('ciclo','dropdown',array('0'=>'Diario','1'=>'Mensual','2'=>'Anual'));
            $crud->field_type('status','dropdown',array('1'=>'Activo','0'=>'Inactivo'));
            $crud->field_type('destinatarios','set',array('Todos','Personas','Empresas','Preferenciales','Premiums'));
            $crud->field_type('siguiente_notificacion','invisible');
            $crud->field_type('funcion','enum',array('calculo de liquidaciones'));
            $crud->add_action('Probar Script','',base_url('panel/notificar').'/');

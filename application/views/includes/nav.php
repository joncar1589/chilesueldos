      ...
      <ul class="nav navbar-nav">                
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <!-- <li><a href="<?= base_url('empresa/salud'); ?>">Salud</a></li> Quitado el  07/10/2014 por Victor Alarcon-->                        
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?= base_url('preferencial/carga'); ?>">Carga masiva de empleados</a></li>                        
            <li><a href="<?= base_url('preferencial/carga_sueldos'); ?>">Carga masiva de sueldos</a></li>                        
          </ul>
        </li>
        <?php endif ?>        
      </ul>      

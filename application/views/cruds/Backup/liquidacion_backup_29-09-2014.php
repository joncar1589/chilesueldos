...
//           var dias = new Date(parseInt(f[2]) || new Date().getFullYear(),parseInt(f[1]), 0).getDate();
    ...
    function calculos()
    {
        ...
        var dias_trabajados = parseInt($("#field-dias_trabajados").val());
        ...
        var totalnoimponible = locomocion + colacion + otras_asignaciones + familiares + parseInt($("#field-indem_sustit").val()) + parseInt($("#field-indem_anos").val());
	...
	total_descuentos = !isNaN(total_descuentos)?total_descuentos.toFixed(0):0;
        ...
        var total_fonasa = adicional_salud+salud;
        ...
        var total_leyes_sociales = afp+afc+ips+total_fonasa;

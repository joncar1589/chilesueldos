...
$this->fpdf->cell(80,5,$liquidacion->empresa.' '.$liquidacion->empresarut,0,0);
$this->fpdf->Ln();
$this->fpdf->cell(40,5,'TRABAJADOR',0,0);
$this->fpdf->cell(80,5,$liquidacion->apellido_paterno.' '.$liquidacion->apellido_materno.' '.$liquidacion->nombre.' '.$liquidacion->rutempleado,0,0);
$this->fpdf->Ln();
...
$this->fpdf->cell(40.5,5,'INP/Mutual',0,0,'L');
$this->fpdf->cell(30.5,5,number_format($liquidacion->inp_mutual,0,',','.'),0,0,'R');
...
//Se imprimen los impuestos
    if($i==1)
    {
        ...
        $this->fpdf->cell(30.5,5,number_format($liquidacion->mutualidad,0,',','.'),0,0,'R',true);
        $this->fpdf->cell(40.5,5,'',0,0,'L');
        $this->fpdf->cell(30.5,5,'',0,0,'L');
        ...
        $this->fpdf->cell(27,5,'',0,0,'L');
        $this->fpdf->cell(13,5,'',0,0,'L');
        $this->fpdf->cell(55,5,utf8_decode('Cotización Obligatoria (7)%'),0,0,'L',true);
